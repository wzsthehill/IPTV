...
<div id="readme" class="Box-body readme blob js-code-block-container p-5 p-xl-6 gist-border-0">
    <div class="markdown-body entry-content container-lg" itemprop="text"
         style="color: blue;font-weight: bolder;font-size: 2em;margin-bottom: 1em"><strong>本项目<span style="color: red;">免责声明：本项目直播源均搜集自互联网，完全免费公开分享，不存在任何收费行为，如果你在其它收费源中看到了本项目的直播源，请不要误会，他们只是直接搬运连测试源都懒得替换，本项目绝对不背这黑锅，另外也请不要把直播源搬运至国内论坛或者自媒体平台，造成的任何影响与本项目无关！！</span></div>
